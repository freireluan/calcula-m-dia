...
console.log(somaingles,mediaingles)
...
function artes (form){
    var artes11 = form.arteprimeiro.value;
    ...
    media = calculaMédiaM(artes1, artes2, artes3);
    somaartes.textContent = soma;
    mediaartes.textContent = media;
 ...
 function Biologia (form){
    ...
    media = calculaMédiaM(Biologia1, Biologia2, Biologia3);
    somaBiologia.textContent = soma;
    mediaBiologia.textContent = media;
 ...
 function EFisica (form){
   ...
   media = calculaMédiaM(EFisica1, EFisica2, EFisica3);
   somaEFisica.textContent = soma;
   mediaEFisica.textContent = media;
 ...
 function Filosofia (form){
    ...
    media = calculaMédiaM(Filosofia1, Filosofia2, Filosofia3);
    somafiloosfia.textContent = soma;
    mediafilosofia.textContent = media;
 ...
 function fisica (form){
    ...
    var media = calculaMédiaM(fisica1, fisica2, fisica3);
    somafisica.textContent = soma;
    mediafisica.textContent = media;
 ...
 function geografia (form){
    ...
    media = calculaMédiaM(geografia1, geografia2, geografia3);
    somageografia.textContent = soma;
    mediageografia.textContent = media;
 }
 function historia (form){
    ...
    var media = calculaMédiaM(historia1, historia2, historia3);
    somahistoria.textContent = soma;
    mediahistoria.textContent = media;
  ...
  function portugues (form){
     ...
     media = calculaMédiaM(portugues1, portugues2, portugues3);
     somaportugues.textContent = soma;
     mediaportugues.textContent = media;
 ...
 function matematica (form){
    ...
    var media = calculaMédiaM(matematica1, matematica2, matematica3);
    somamatematica.textContent = soma;
    mediamatematica.textContent = media;
 ...
 function quimica (form){
    ...
    media = calculaMédiaM(quimica1, quimica2, quimica3);
    somaqumica.textContent = soma;
    mediaquimica.textContent = media;
 ...
 function Sociologia (form){
    ...
    media = calculaMédiaM(Sociologia1, Sociologia2, Sociologia3);
    somasociologia.textContent = soma;
    mediasociologia.textContent = media;
 ...
 function Efinanceira (form){
    ...
    var media = calculaMédiaM(Efinanceira1, Efinanceira2, Efinanceira3);
    somaEFinanceira.textContent = soma;
    mediaeFinanceira.textContent = media;
 ...
 function ingles (form){
   ...
   var media = calculaMédiaM(ingles1, ingles2, ingles3);
   somaingles.textContent = soma;
   mediaingles.textContent = media;
